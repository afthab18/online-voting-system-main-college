...
<div class="container-fluid" id="cont-3">
	...
	$sql = "select * from candidates_as order by id desc";
	...
	foreach($rs as $row){
		...
		<tr>
			...
			if($row['approve_status']==2){
				echo '<a href="change_status_as.php?id='.$cid.'&status=1" class="btn btn-success">Approve</a>';
			}else if($row['approve_status']==1){
				echo '<a href="change_status_as.php?id='.$cid.'&status=2" class="btn btn-danger">Reject</a>';
