          ...
          <nav class="navbar navbar-expand-lg navbar-light bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav ml-auto animate__animated animate__bounceInDown" style="padding-right: 50px;">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="result_position.php" style="color: white; font-weight: 600; text-align: center; font-size: 18px; margin-top: 20px;  text-transform: capitalize; padding: 20px;">Result</a>
                </li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6" >
                ...
                <form action="SavedData_vcp.php" method="post" id=ConfirmForm> 
                <table>
        ...
        $sql = "select name from candidates_vcp where approve_status=1";
